...
const PdfHeader = ({ reference }) => (
  <>
    ...
    const getWaterproofPagesCount = ({ guarantee, surface }) => {
      // The 25-year system adds a three-page FastCoat MidCoat stage.
      // Fully primed substrates add the two MS 2-Part Primer pages.
      const systemPages = guarantee === '25-year' ? 14 : 11;
      return systemPages + (fullyPrimedSurfaces.includes(surface) ? 2 : 0);
    };
    ...
    const baseSections = [
      ...
      ...(image ? [{ title: 'Roof specification', pages: 1 }] : []),
      ...
      ...(photos?.length > 0 ? [{ title: 'Photographs', pages: 1 }] : []),
    ...
    const cleaningStartPage = getPageNumber('Cleaning, TV, satellite arrays, cables');
    const waterproofStartPage = getPageNumber('Waterproof coverings');
    const primerPageCount = isFullyPrimed ? 2 : 0;
    const baseCoatStartPage = waterproofStartPage + primerPageCount + 2;
    const baseCoatInspectionPage = baseCoatStartPage + 2;
...
<Page size="A4" style={styles.page}>
  ...
  <View style={{ marginTop: 14 }}>
    ...
    <View style={{ marginLeft: 16, marginBottom: 12 }}>
      ...
      <Text style={styles.text}>• Follow the cleaning steps outlined previously if necessary (see page {cleaningStartPage}).</Text>
    </View>
...
<View style={{ marginTop: 14 }}>
  ...
  <Text style={[styles.text, { marginBottom: 8 }]}>Please see page {cleaningStartPage}.</Text>
  ...
  <Text style={[styles.text, { marginBottom: 8 }]}>Please see page {baseCoatStartPage}.</Text>
  ...
  {guarantee === '20-year' && (
    <>
      ...
      <View style={{ marginLeft: 16, marginBottom: 8 }}>
        ...
        <Text style={styles.text}>
          • Apply an additional 0.5kg of FastCoat Waterproof per m² on top of the matting to ensure it is fully saturated and covered. Once the Reinforcement Matting has broken down and softened, complete the embedment to remove all pinholes.
        </Text>
      </View>
    </>
  )}
...
<View style={{ marginTop: 14 }}>
  <Text style={styles.label}>{guarantee === '25-year' ? '6. Repeat Process' : '7. Repeat Process'}</Text>
  <View style={{ marginLeft: 16, marginBottom: 8 }}>
    <Text style={styles.text}>
  ...
  <Text style={styles.label}>{guarantee === '25-year' ? '7. Drying Time' : '8. Drying Time'}</Text>
  <View style={{ marginLeft: 16, marginBottom: 8 }}>
    <Text style={styles.text}>
  ...
  <Text style={styles.label}>{guarantee === '25-year' ? '8. Clean Up' : '9. Clean Up'}</Text>
  <View style={{ marginLeft: 16 }}>
    <Text style={styles.text}>• Clean tools and equipment after use.</Text>
  ...
  <View style={{ marginLeft: 16, marginBottom: 8 }}>
    <Text style={styles.text}>• 2kg / m² (Smooth Surface) – 12.5m² / 25kg tin</Text>
    <Text style={styles.text}>
      • {guarantee === '25-year'
...
{guarantee === '25-year' ? (
  <View style={{ marginTop: 14 }}>
    <Text style={styles.sectionTitle}>FastCoat MidCoat</Text>
    <Text style={styles.label}>Steps for Applying FastCoat MidCoat:</Text>
    ...
    <View style={{ marginLeft: 16, marginBottom: 8 }}>
      ...
      <Text style={styles.text}>• Clean surface: Make sure the surface is clean and free from dust and debris. See page {baseCoatInspectionPage}.</Text>
    </View>

    <Text style={styles.label}>3. Reactivation of the Surface (if required)</Text>
    <View style={{ marginLeft: 16, marginBottom: 8 }}>
      <Text style={styles.text}>• If the BaseCoat has been left for more than 14 days, reactivate the surface using MS 2-Part Primer.</Text>
      <Text style={styles.text}>• Apply the primer as per LRS instructions and allow it to dry completely before applying FastCoat Waterproof.</Text>
    </View>

    <Text style={styles.label}>4. Mixing FastCoat MidCoat</Text>
  </View>
) : (
  <View style={{ marginTop: 14 }}>
    <Text style={styles.sectionTitle}>FastCoat TopCoat</Text>

    <Text style={[styles.text, { marginBottom: 8 }]}>
      Applying FastCoat TopCoat is the critical final coating step in creating a durable and watertight flat roof.
    </Text>

    <Text style={styles.label}>Steps for Applying FastCoat TopCoat:</Text>
    ...
    <View style={{ marginLeft: 16, marginBottom: 8 }}>
      <Text style={styles.text}>• If the BaseCoat has been left for more than 14 days, reactivate the surface using MS 2-Part Primer.</Text>
      <Text style={styles.text}>• Apply the primer as per LRS instructions and allow it to dry completely before applying FastCoat TopCoat.</Text>
    </View>

    <Text style={styles.label}>4. Mixing FastCoat TopCoat</Text>
  </View>
)}
...
{guarantee === '25-year' && (
<>
  {/* FastCoat MidCoat – application and technical data */}
  <Page size="A4" style={styles.page}>
    <PdfHeader reference={reference} />

    <Text style={styles.text}>
      • Thoroughly mix FastCoat Waterproof before application. Use a drill with mixing attachment or mixing stick to ensure uniform consistency.
    </Text>
    ...
    <View style={{ marginLeft: 16, marginBottom: 8 }}>
      <Text style={styles.text}>• Allow FastCoat Waterproof to dry for 2–4 hours, depending on environmental conditions such as temperature and humidity.</Text>
    </View>

    <Text style={styles.label}>7. Final Inspection</Text>
    <View style={{ marginLeft: 16, marginBottom: 8 }}>
      <Text style={styles.text}>• Check the roof to ensure FastCoat Waterproof has been applied evenly across the entire surface.</Text>
    ...
    <Text style={[styles.label, { marginTop: 8 }]}>FastCoat Waterproof as a MidCoat</Text>
    <Text style={styles.text}>Single component, moisture-curing polyurethane.</Text>
    <Text style={styles.text}>Container Size – 25kg</Text>

    <Text style={[styles.label, { marginTop: 10 }]}>Coverage Rates (Typical)</Text>
    <Text style={styles.text}>• 1kg / m² (Smooth Surface) – 25m² / 25kg tin</Text>
    <Text style={styles.text}>• 1.5kg / m² (Rough Surface) – 16.6m² / 25kg tin</Text>
    <Text style={styles.text}>Allowance should be made for additional coverage rates at low temperatures.</Text>

    <Text style={[styles.label, { marginTop: 10 }]}>Typical Drying Times at 15°C</Text>
    <Text style={styles.text}>Touch Dry – 3 hours</Text>
    <Text style={styles.text}>Minimum Over Coat – 4 hours</Text>
    <Text style={styles.text}>Full Cure – 7 days</Text>
  ...
  {/* FastCoat MidCoat – storage and application conditions */}
  <Page size="A4" style={styles.page}>
    <PdfHeader reference={reference} />

    <Text style={[styles.label, { marginTop: 10 }]}>Storage</Text>
    <Text style={styles.text}>FastCoat should be stored between 5°C and 20°C and kept out of the weather elements.</Text>

    <Text style={[styles.label, { marginTop: 10 }]}>Application Temperatures</Text>
    <Text style={styles.text}>FastCoat application is based on surface temperature and should be applied between +5°C and a maximum surface temperature of 35°C.</Text>

    <PdfFooter guarantee={guarantee} pageNumber={getPageNumber('Waterproof coverings') + waterproofPageIndex++} />
  </Page>

  {/* FastCoat TopCoat – 25-year system */}
  <Page size="A4" style={styles.page}>
    <PdfHeader reference={reference} />

    <View style={{ marginTop: 14 }}>
      <Text style={styles.sectionTitle}>FastCoat TopCoat</Text>
      <Text style={[styles.text, { marginBottom: 8 }]}>Applying FastCoat TopCoat is the critical final coating step in creating a durable and watertight flat roof.</Text>
      <Text style={styles.label}>Steps for Applying FastCoat TopCoat:</Text>
...
{/* FastCoat TopCoat – application and technical data */}
<Page size="A4" style={styles.page}>
<PdfHeader reference={reference} />

<Text style={styles.text}>
• Thoroughly mix FastCoat TopCoat before application. Use a drill with mixing attachment or mixing stick to ensure uniform consistency.
    </Text>
...
• <Text style={{ fontWeight: 'bold' }}>Coverage Rate:</Text> Apply FastCoat TopCoat at a coverage rate of 0.3kg per m².
  ...
  <View style={{ marginLeft: 16, marginBottom: 8 }}>
    <Text style={styles.text}>
      • Allow FastCoat TopCoat to dry for 2–4 hours, depending on environmental conditions such as temperature and humidity.
    </Text>
  </View>

  <Text style={styles.label}>7. Final Inspection</Text>
  <View style={{ marginLeft: 16 }}>
    <Text style={styles.text}>• Check the roof to ensure FastCoat TopCoat has been applied evenly across the entire surface.</Text>
    <Text style={styles.text}>• Perform any necessary touch-ups with additional FastCoat TopCoat to cover missed spots or thin areas.</Text>
  </View>

<Text style={[styles.label, { marginTop: 8 }]}>FastCoat TopCoat</Text>
<Text style={styles.text}>
  Single component polyurethane, solvent-based aliphatic coloured TopCoat.
</Text>
<Text style={styles.text}>Container Size – 5.5kg</Text>

<Text style={[styles.label, { marginTop: 10 }]}>Coverage Rates (Typical)</Text>
<Text style={styles.text}>• 0.3kg / m² (Smooth Surface) – 18.3m² / 5.5kg tin</Text>
...
{/* FastCoat TopCoat – storage and application conditions */}
<Page size="A4" style={styles.page}>
<PdfHeader reference={reference} />

<Text style={[styles.label, { marginTop: 10 }]}>Storage</Text>
<Text style={styles.text}>
  FastCoat TopCoat should be stored between 5°C and 20°C and kept out of the weather elements.
</Text>

<Text style={[styles.label, { marginTop: 10 }]}>Application Temperatures</Text>
<Text style={styles.text}>
  FastCoat TopCoat application is based on surface temperature and should be applied between +5°C and a maximum surface temperature of 35°C.
</Text>
...
<View style={{ marginTop: 14 }}>
  ...
  <Text style={[styles.text, { marginBottom: 12 }]}>
    ...
    {guarantee === '20-year' ? '20 years' : '25 years'} from the date of practical completion.
  </Text>
  <Text style={styles.text}>
