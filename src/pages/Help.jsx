  ...
  const helpData = [
    {
      ...
      instructions: [
        ...
        { title: 'Image Upload for Roof Specification', description: 'Click the button labeled “Upload an image for Roof Specification”. This will open your device’s file explorer. Once you select an image, a preview will appear. If you wish to replace it, click the button again and choose a new file. The button will automatically update with the new image.' },
        { title: 'Roof Type', description: 'Choose between Warm Roof, Inverted Roof or Existing Overlay. This selection changes the structure of the build-up in the PDF.' },
  { title: 'U Value Needed', description: 'Required only when Warm Roof is selected. Enter the U value (e.g., 0.15 W/m²K).' },
  { title: 'Outlets', description: 'Enter the number of roof outlets, or type “TBC” if unknown.' },
  { title: 'Skylights', description: 'Enter the number of skylights, or type “TBC” if unknown.' },
  { title: 'AC Units', description: 'Enter the number of Air Conditioning units on the roof, or type “TBC”.' },
  { title: 'Existing Coatings', description: 'Select whether existing coatings are present on the roof. Choose “Yes” or “No”.' },
{ title: 'Ponding Water', description: 'Indicate if there is standing water on the roof after rainfall. Choose “Yes” or “No”.' },
      ],
      pdfSteps: [
